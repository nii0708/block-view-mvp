...
export const extractPDFCoordinatesNative = async (
  ...
  try {
    ...
    // Extract arrays using the same pattern as your JavaScript code
    const arrayPattern =
    ...
    if (gptsData && gptsData.values.length === 8) {
      ...
      console.log("Parsed GPTS coordinates:", coordinates);
    } else {
      ...
      if (lptsData && lptsData.values.length === 8) {
        ...
        console.log("Converted LPTS to coordinates:", coordinates);
      }
    }
