...
export function processCrossSectionBlocks(blockModelData: any[], sourceProjection: any, startLat: any, startLng: any, endLat: any, endLng: any) {
    try {
    ...
    const endPoint = { lat: endLat, lng: endLng };
      ...
      function lineSegmentIntersection(x1: any, y1: any, x2: any, y2:any, x3:any, y3:any, x4:any, y4:any) {
      ...
      function findLineSegmentIntersection(x1: any, y1: any, x2: any, y2: any, x3:any, y3:any, x4:any, y4:any) {
      ...
      function calculateIntersectionPoints(lineStart:any, lineEnd:any, polygon:any) {
        const intersections = [];
