...
export function processElevationData(elevationData: any[], sourceProjection: any, startLat: number, startLng: number, endLat: number, endLng: number, lineLength: number) {
    try {
